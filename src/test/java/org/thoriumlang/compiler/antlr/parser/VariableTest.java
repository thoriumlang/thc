...
class VariableTest {
    ...
    void implicitConstantWitType() {
        ...
        ).isEqualTo("(constOrVarDef name : (typeSpec (typeSpecSimple (fqIdentifier type))) = (expression 1) ;)");
    }
    ...
    void explicitConstantWithType() {
        ...
        ).isEqualTo("(constOrVarDef val name : (typeSpec (typeSpecSimple (fqIdentifier type))) = (expression 1) ;)");
    }
    ...
    void explicitVariableWithTypeWithoutValue() {
        ...
        ).isEqualTo("(constOrVarDef var name : (typeSpec (typeSpecSimple (fqIdentifier type))) ;)");
    }
    ...
    void explicitVariableWithTypeWithValue() {
        ...
        ).isEqualTo("(constOrVarDef var name : (typeSpec (typeSpecSimple (fqIdentifier type))) = (expression 1) ;)");
    }
}
