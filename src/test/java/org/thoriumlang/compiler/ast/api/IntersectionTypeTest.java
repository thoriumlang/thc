...
class IntersectionTypeTest {
    ...
    void notSame_equals_hashCode() {
        ...
        Type type1 = new IntersectionType(Collections.singletonList(
                unit.findClass("Class").orElseThrow(() -> new IllegalStateException("type not found"))
        ));
        Type type2 = new IntersectionType(Collections.singletonList(
                unit.findClass("Class").orElseThrow(() -> new IllegalStateException("type not found"))
        ));
...
//
//        SymbolTable symbolTable = classAst.root()
//                .getContext()
...
//                .findClass("Class")
//                .flatMap(c -> c.findMethod("methodWithUnionOfIntersectionType"))
